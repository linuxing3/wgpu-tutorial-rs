...
pub trait Example: 'static + Sized {
    ...
    fn required_limits() -> wgpu::Limits {
        ...
        wgpu::Limits::downlevel_webgl2_defaults() // These downlevel limits will
                                                  // allow the code to run on
...
async fn setup<E : Example>(title : &str) -> Setup {
    ...
    // support images the size of the surface.
...
pub fn run<E : Example>(title : &str) {
    ...
    wasm_bindgen_futures::spawn_local(async move {
        ...
        // again. This is required, because winit uses JS exception for control
        // flow to escape from `run`.
...
#[cfg(target_arch = "wasm32")]
/// Parse the query string as returned by
/// `web_sys::window()?.location().search()?` and get a specific key out of it.
            ...
            cmd_buf.copy_texture_to_buffer(
                ...
                wgpu::ImageCopyBuffer {
                    ...
                    layout : wgpu::ImageDataLayout {
                        offset : 0,
                        bytes_per_row : std::num::NonZeroU32::new(params.width * 4),
                        rows_per_image : None,
                    },
                },
                wgpu::Extent3d {
