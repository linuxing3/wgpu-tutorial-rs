...
impl framework::Example for Example {
    ...
    fn required_features() -> wgpu::Features { wgpu::Features::TEXTURE_BINDING_ARRAY }
    ...
    fn init(
        ...
        // TODO: Because naga's capibilities are evaluated on validate, not on write, we
        // cannot make a shader module with unsupported capabilities even if we
        // don't use it. So for now put it in a separate module.
...
fn main() { framework::run::<Example>("texture-arrays"); }
